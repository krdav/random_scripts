        ...
        for chain_name, lines in self.chain_lines.items():
            ...
            with open(outname, 'w') as fh_out:
                ...
                for line in lines:
                    ...
                    # Save the mapping:
                    self.mapping_dict[chain_name][new_line[21:27]] = line[21:27]  # Notice that the list slice is including both chain name, residue number and insertion code
        ...
        for pair in self.dimers:
            ...
            with open(outname, 'w') as fh_out:
                ...
                for line in all_lines:
                    ...
                    print(new_line, file=fh_out)
                    # Save the mapping:
                    self.mapping_dict[pair][new_line[21:27]] = line[21:27]  # Notice that the list slice is including both chain name, residue number and insertion code
